...
\entry{av́ár}{v. irreg.}{\pf{avoir}}{+\s{acc} To have \textit{(usually inalienably)}.}{\s{pres ant} and \s{pret} y, \textit{obsolete} \s{pret} ab’hẹ, \s{fut} aúrẹ́, \s{subj} ès}
...
\entry{c’hes}{quest. part.}{\pf{qu’est-ce que}}{\textit{see grammar; often enclitic \w{-c’h’s} in older texts}.}{}
