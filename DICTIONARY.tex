...
\refentry{se}{eḍ}
\refentry{seb’h}{eḍ}
\entry{sẹh}{pro.}{\pfabbr ceci}{+\s{def} *noun* This, these *(precedes and is attached to nouns)*}{}{}
...
\entry{sý’ẹ}{pro.}{\pfabbr cela}{+\s{def} *noun* That, those *(precedes and is attached to nouns; generally* **sý’** *before vowels, with one apostrophe, not two)*}{}{}
\refentry{s’}{sá}
...
\entry{ub’hrá}{v.}{\pfabbr pouvoir}{1. +\s{inf} To be able to, can. 2. +\s{part} Capable of ..}{\s{fut} *úrẹ́*, \s{subj} *ís*}{}
