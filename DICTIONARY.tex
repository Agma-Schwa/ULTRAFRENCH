...
\entry{aḅrâ}{v.}{\pf{apprendre}}{\\+\s{part} \s{or intr.} To learn.\\+\s{acc} To teach (+\s{dat} sbd.). {\itshape{}See also.}}{\s{fut} aḅrâdé, \s{subj} aḅrâs}
...
\entry{áhaúr}{adv.}{\pf{encore}}{\\\textit{(positive context)} Still, again.\\\textit{(negative context)} Not yet.}{}
