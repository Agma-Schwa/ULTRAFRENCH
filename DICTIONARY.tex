...
\entry{c’hóvâ}{v.}{\pf{commencer}}{\\(\s{+ part}) To start, commence, begin.\\\s{+ gen} To start out as.\\\w{âc’hóvâ} \s{def} Beginning, start. {\itshape{}Lit. ‘that which is being begun’.}}{\s{fut} c’hóvârẹ́, \s{subj} c’hóv\-ás}
...
\entry{rét’hévâ}{n.}{\pf{traitement}}{Failure.}{}
...
\entry{séḅ}{num.}{}{Once.}{}
\entry{sebhár}{v. tr. or refl.}{\pf{séparar}}{+\s{acc} To contrast sth. (+\s{gen} with sth.).}{\s{subj} sebhás, \s{fut} sebháre}
