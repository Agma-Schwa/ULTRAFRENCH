...
\centering
\itshape
\begin{tabular}{l|lll|l|ll|l|l|l|}
\bf Consonant & x & s & z       & c & b & f          & ḅ   & d   & ḍ    \\\hline
\bf Lenited & \multicolumn{3}{c|}{h} & c̣ & \multicolumn{2}{c|}{b’h} & bh  & d’h & t’h  \\
\end{tabular}
\nf
...
Instrumental  & b’hel-  & b’he-   &&Instrumental  & b’hehý(n)- & b’heh-  \\
\end{tabular}
...
passive forms,\footnote{At the same time, the \s{1sg} forms seem to be derived from the \s{acc} of the PF \s{1sg} pronoun,
for unknown reasons.} as well as the Future I. All forms of the
copula are shown in Tables~\ref{tab:ed-paradigm-ind}–\ref{tab:ed-paradigm-opt} below, except for the Conditional I and II,
...
\noindent Unlike nearly every other word in the language, disyllabic forms of the copula are stressed on
...
Table~\ref{tab:personal-pronouns} below lists all forms of the UF personal pronouns.
\begin{table}[H]
\centering\itshape
\begin{tabular}{@{}>{\nf}l|llll|lll}
...
three are indeclinable and precede whatever they qualify: the first generally occurs in isolation or with an adjective,
e.g. *swi ḅẹt’hâ* ‘the small one’, the latter two always precede a definite noun, e.g. *sẹh lát’halẹ* ‘this table’. It
...
construction is generally preferred over inflecting the relative pronoun.
