...
\centering
\let\M\multicolumn
\noindent\begin{tabular}{l|>{\it}l|>{\it}l|>{\it}l|>{\it}l|>{\it}l|>{\it}l}
&\M{2}{c|}{Present}&\M{2}{c|}{Pres. Ant.}&\M{2}{c}{Preterite}\\\cline{2-7}
\s{to be}        &\nf Sg&\nf Pl  & \nf Sg &\nf Pl  & \nf Sg &\nf Pl \\\hline
\s{1st} & vy’í  & aúsó   & vẹ     & aúfý   & vet’h  & weḍy’ó   \\
\s{2nd} & ḍe    & b’heḍ  & ḍyf    & b’hu   & ḍet’h  & b’heḍy’é \\
\s{3m}  & le    & lẹsó   & leb’h  & lẹfýr  & let’h  & let’he   \\
\s{3f}  & lle   & llẹsó  & lle’bh & llẹfýr & llet’h & llet’he \\
\s{3n}  & se    & lasó   & seb’h  & lafýr  & set’h  & laet’h  \\\hline
\s{inf}& \M{2}{c|}{\it éḍ} &\M{2}{c|}{\it éfyḍ} & \M{2}{c}{\it ét’hẹd} \\
\end{tabular}
