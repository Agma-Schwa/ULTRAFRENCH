...
There are no adpositions in UF—a fact for which it compensates with a total of 49 cases. There are 2 declensions:
...
If the future stem ends with \w{e}, \w{ẹ}, \w{é}, or \w{è}, that vowel is dropped if any future suffix or a suffix that starts with a vowel is added, e.g.
