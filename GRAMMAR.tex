...
Postlative    & réh-\L         & réh-     && Postlative    & réhýn-\N     & réhyl-   \\ % From reculer
Interessive   & aḍá-           & aḍé-     && Interessive   & aḍŷn-        & aḍŷ-     \\
Superessive   & sýr-           & dẹ(h)-\L && Superessive   & dẹhýn-       & sýrŷ-    \\
Perlative     & lý’aú-\L(d’h)- & lý’aú-   && Perlative     & lý’ýn-       & lý’ý-    \\ % from le long de
...
Contrative    & c’haú-\L       & c’haú-   && Contrative    & c’haút’hýn-  & c’haút’hý- \\ % from contre
\end{tabular}
...
The \s{insv} case is used for the ‘subject’ of a so-called \textit{instructive absolute}, which is similar to the
...
and \w{vvaúríhêr} ‘having remembered’.
...
its own, and is always inflected in that case, e.g. \s{dat} \w{asa jad’hór} ‘to the one I love’.
