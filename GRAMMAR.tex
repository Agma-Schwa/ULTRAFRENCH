...
\begin{examples}
    ...
    \item \w{\b{ráh}ráhut’h b’helvê} ‘(with) sword in hand’
\end{examples}
...
\s{gen} pronoun is generally omitted:\footnote{With body parts, this use of the \s{gen} is entirely obsolete in Modern UF,
...
Cardinal numbers function much like proper adjectives and are placed after the noun or noun phrase they qualify.
