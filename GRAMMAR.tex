...
\noindent\begin{tabular}{@{}|l|l|l|l|l|l|l@{\quad}|l|l|l|}                                                   \cline{1-6} \cline{8-10}
    ...
    Nasal              &        & n        &          &       &         && Near-close &              &             \\ \cline{1-6} \cline{8-10}
    ...
    Approximant        &        &          & ɥ ɥ̃, j̊   & ɰ ɰ̃   &         && Near-open  &              &             \\ \cline{1-6} \cline{8-10}
    Lateral Fricative  &        & ɮ̃        & ʎ̝̃        &       &         && Open       & a ḁ          & ɑ̃ ɑ̃̃         \\ \cline{1-6} \cline{8-10}
\end{tabular}}\bigskip
...
are nasalised, e.g. the pronunciation of *ad’hór*, which we just transcribed as /aˈðɔ̃ɰ/, is actually closer to [a̯ˈðɔ̃ˠˑ].
Word-final voiceless `e` is always /ə̥/.

Oral vowels have a nasalised and nasal counterpart. /i/, /y/, and /u/ do not vary in quality when nasalised. /a/ is normally [a],
...
\subsubsection{Introduction to Prefixed Tenses and Future I}
...
\subsubsection{Consonantal Future II}
The Future I paradigm is fairly straight-forward; unfortunately, the Future II is a lot worse: not only does the prefix
vary a lot more, but it also changes based on whether the stem starts with a vowel or a consonant.\footnote{This is
not a problem in the Future I, since the prefix is never adjacent to the stem.}
Table~\ref{tab:future-2-consonantal}
gives an overview over the more regular, consonantal Future II forms, which are before verb forms that start with
a consonant.
...
3rd m &aúr-  -(ẹ) &laú- -aú    &&3rd m &y’aúr-  &laú- -e \\\cline{1-3}\cline{5-7}
3rd f &aúr-  -(ẹ) &laú- -aú    &&3rd f &y’aúr-  &laú- -e \\\cline{1-3}\cline{5-7}
3rd n &aúr-  -(ẹ) &laú- -aú    &&3rd n &saúr-   &laú- -e \\\cline{1-3}\cline{5-7}
...
\noindent The diachrony of these forms is somewhat unclear. It would appear, however, that they result from a coalescence
of the personal pronouns with forms of some auxiliary (likely PF *avoir*) as well as the PF future. It appears that
...
The future stem usually ends with a vowel, which is dropped if a suffix that starts with a vowel is added, e.g.
*laúvvaúríźaú* ‘they will remember’, not \**laúvvaúríźeaú*. As in the present, the dictionary form of the future
...
with the nasalisation of the final vowel to become *aû*. The \s{act sg} *-ẹ* desinence becomes *-ẹ́* for such verbs,
e.g. *aúrdírẹ́* ‘he will say’.
...
Table~\ref{tab:future-2-vvaurihe} below shows the complete Future II paradigm of the verb *vvaúríhe* ‘to remember’; recall that the future
stem is *vvaúríźe*.
...
\subsubsection{Vocalic Future II}
There is another set of affixes, which are used with verb forms that start with a vowel. These are shown in
Table~\ref{tab:future-2-vocalic} below. The suffix parts of these affixes are the same, but the prefix parts
are quite different.
...
\noindent\begin{tabular}{@{}|>{}l|>{\it}l|>{\it}l|>{}l|>{}l|>{\it}l|>{\it}l|}\cline{1-3}\cline{5-7}
Active&\nf Sg&\nf Pl& & Passive&\nf Sg&\nf Pl\\\cline{1-3}\cline{5-7}
1st   &b’h- -(ẹ)  &náý’- -aú &&1st   &vaú- é  &naú-       \\\cline{1-3}\cline{5-7}
2nd   &ḍír- -(ẹ)  &v́aú- -e     &&2nd   &\d{}á-  &b’haú-     \\\cline{1-3}\cline{5-7}
3rd m &ł-  -(ẹ)   &laú- -aú    &&3rd m &y’aúr-  &laú- -(r)e \\\cline{1-3}\cline{5-7}
3rd f &èł-  -(ẹ)  &laú- -aú    &&3rd f &y’aúr-  &laú- -(r)e \\\cline{1-3}\cline{5-7}
3rd n &aúł-  -(ẹ) &laú- -aú    &&3rd n &saúr-   &laú- -(r)e \\\cline{1-3}\cline{5-7}
Infinitive&\multicolumn{2}{c|}{\it dẹ- -è}&&Infinitive&\multicolumn{2}{c|}{\it haú-}\\\cline{1-3}\cline{5-7}
\end{tabular}
\caption{Vocalic Future II Affixes.}\label{tab:future-2-vocalic}
\end{table}

\noindent Unlike the consonantal affixes, the vocalic affixes appear to be derived from the present and future
tenses of the PF verb *aller*.
