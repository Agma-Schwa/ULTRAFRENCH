...
\noindent\begin{tabular}{@{}|l|l|l|l|l|l|l@{\quad}|l|l|l|}                                                   \cline{1-6} \cline{8-10}
    ...
    Fricative  & ɸ β, ʋ̃ & s z, θ ð & ç ɕ ʑ    & x χ   & h       && Mid       & \multicolumn{2}{c|}{ə ⟨\e{}⟩ ə̥}   \\ \cline{1-6} \cline{8-10}
...
TODO: Change neuter to be derived from ‘ce’.
TODO: Document coalescence of the first and second person suffixes when a verb ends with a vowel.
...
accusative, are borrowed from demonstratives instead (\s{def} from PF \**celui* and \s{indef} from PF \**ce*); the definite partitive forms are from the PF partitive article, and
...
\section{Examples}
As an example, the sentence below is the UF translation of ‘Charles, you bought a fish on the mountain?’.
