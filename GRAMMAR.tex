...
Neither tense distinguishes gender in the third person. All suffixes, except for the infinitive and \s{1pl, 2pl pret},
...
\noindent Diachronically, the \s{1sg pret} is an interesting case; in EUF, it was originally \**-é*, but it later changed to *-á*
...
\multicolumn{5}{@{}l}{\it Ç̇ár, c’hes sráhó dwávôt’há ḍaç̇t’heá?}\\
Ç̇ár &c’hes &s-ráhó &dwá-vôt’há &ḍ-aç̇t’he-á\\
ˈj̊ɑ̃ɰ&ɕes&ˌsɰɑ̃ˈhɔ̃&dɰɑ̃ˌʋ̃ɔ̃̃ˈθɑ̃&daj̊ˈθe.ɑ̃\\
Charles.\s{voc}&\s{q part}&\s{indef.acc}-fish&\s{def.iness}-mountain&\s{2sg}-buy-\s{pres.ant.2sg}\\
