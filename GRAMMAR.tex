...
%\Paragraph{Glossary}
%Besides the usual abbreviations for cases, e.g. \s{acc}, \s{nom}, \s{part}, the dictionary uses a few more
%abbreviations and annotations that aren’t too common elsewhere in this grammar:
%\begin{description}
%    \item[\textit{(serial)}] Serial verb construction, i.e. this verb is construed with another finite verb, which it modifies.
%\end{description}
