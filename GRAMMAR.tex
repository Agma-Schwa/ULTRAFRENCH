...
Oral vowels have a nasalised and nasal counterpart. /i/ and /u/ do not vary in quality when nasalised.
...
\noindent Unlike nearly every other word in the language, mono- and disyllabic forms of the copula are stressed on
...
‘(a) fortieth’; in the hundreds and after, a final *-(á)ḍ* is added instead.
...
Note that particles may sometimes alsoo be placed after the first word of a clause instead if the first constituent
