...
because it affirms the comparison (‘better, and also good’, ‘less hot, and also not very hot’); the denying comparative, which denies the comparison
(‘better, but not good’, ‘less hot, but still hot’), the sufficient comparative, which indicates that there is just enough of something,
and the neutral comparative, which does not make any statement about the comparison (‘better’, ‘less hot’).
...
In UF, the comparatives are expressed by four infixes, which are prefixed directly to the stem. For positive comparatives, the affirming
...
comparative prefix is \w{haû} and the neutral comparative prefix is \w{raû}. Those are formed from a contraction of the positive prefixes and the
negative marker \w{aû}.
...
The negative superlative is formed with the prefix \w{râdvaû}, which is formed from \w{râdvâ} and \w{aû} similarly to the comparatives.
...
Such a construction is the closest equivalent to a ‘passive voice’ in UF, since there is no true distinct syntactical or
