...
Initial /ɰ/ is sometimes elided after words that end with /ɰ/, particularly in particles (e.g. *rvá* ‘alas’).
...
\item a dot below in *ẹ* indicates that it is a schwa. Note that there is no nasal(ised) schwa;
