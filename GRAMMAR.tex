...
The inessive, interessive, superessive, ablative, and allative are collectively called ‘locatives’ and indicate the position of an object
...
The \w{h} in the \s{spre def pl} is omitted if the following sound is a consonant, e.g. \w{dẹhárb} ‘above the trees’
