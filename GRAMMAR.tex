...
The \s{abw} case is used for the predicate noun of predicative sentences, e.g. *Aúsó ḍe ráhó* ‘We are all fish’.
...
a book’ vs *jlí dŷnliv́uhé* ‘I read from a book’ or ‘I am reading a book’. Consequently, \s{pres ant}
...
Lásásc’hríd raúl révéy’ýr c’hesse?
}
...
\multigloss {
    ...
    lá-sásc’hríḍ|raúl|ré-véy’ýr|c’hes|se
    \s{nom}-Sanskrit|\s{abs}.language|\s{sup}-better|\s{q}|\s{3n}.be
}
...
saying that ULTRAFRENCH speakers can read each others minds and send thoughts to each other.{\color{teal}
...
%%
%% Comparative + \s{aci}: ‘too X to...’. With negation ‘Not X enough to ...’.
%%
...
%%
%% Word order for \s{aci}s puts the infinitive at the very beginning and the accusative at the very end, or vice versa,
