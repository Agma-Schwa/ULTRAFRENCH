...
that only take a theme may translate as ‘active’ (or really, middle) in meaning despite being ‘passive’ in form in UF:
\begin{examples}
    \item \w{Vv́ár dẹḅarḍ.} ‘I must leave.’
\end{examples}

However, these verbs are rare; usually, a syntactic ‘passive’ has passive meaning in the traditional sense. Intransitive verbs
...
\subsection{Names, Titles, and Appositions}\label{subsubsec:names-and-titles}
