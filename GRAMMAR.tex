...
There are no adpositions in UF—a fact for which it compensates with a vast array of cases. There are 2 declensions:
...
% TODO: Postelative, Antallative, Antablative (can’t use ‘Antelative’ since that could be
% ‘Ante-lative’ or ‘Ant-elative’), Citrablative, Citrallative, Transablative, Transallative,
% Delative, Interlative, Interelative, Contrallative, Contrablative, Sublative, Subelative,
% Subessive, Exessive (transition out of a state), Orientative, Revertive, Ornative
...
\def\ufdeclensiontablestretch{1.25} % Set this to whatever is required to fill the page.
\clearpage
\begingroup
...
Distributive      & cat’halẹ         & cac’hḍalẹ          && Distributive    & cahýnḍalẹ       & c’hahýḍalẹ \\ % chaque
\cline{1-3}\cline{5-7}
