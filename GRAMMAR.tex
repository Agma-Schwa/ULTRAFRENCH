...
b’hesaúr rêvú u aû-át’heý’ebhat’he u B’helfaúr sraúb’he.
}
...
\multigloss {
    ...
    aḍŷ-ḅáłýr|át’hebhaú raúl|dẹ-deslẹ|s|aú-t’hiy’e-y’ó|sý-véhýr
    ...
    u|B’he-faúr|s-raúb’he
    or|\s{instr}-Force|\s{acc.pl.indef}-robot
}
...
It’s not racist to say robots are immune to most forms of not-telepathy and the Force. {\color{teal}I have several android friends
...
We can, you see, detect both rays and beams of energy floating between speakers of The Language (= UF)
...
to ‘or’ here.} by the Force is not racist.
