...
\item to express potential modality, e.g. *ḍẹḅars* ‘you may leave’;
\item in the first person, as a jussive, e.g. *rad’hesó* ‘let’s go’;
...
\dlabelstyle{\bfseries\itshape} %% TODO: Create a two-column description list environment.
