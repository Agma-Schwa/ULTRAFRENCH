...
UF has 2 declensions: a definite declension and an indefinite declension. UF has no adpositions—a fact for which it
...
secondary, and tertiary/locative cases (see below).

Some of the case prefixes cause lenition or nasalisation in the initial consonant of the noun, e.g. \w{ḍalẹ} ‘table’ to
\s{def acc sg} \w{s’thalẹ}. Unlike verbal affixes, case prefixes never coalesce with the stem.
